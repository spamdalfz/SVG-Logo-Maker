...
// Function that prompts the user with questions from the questions array
const promptQuestions = () => {
    return inquirer.prompt(questions);
};

// async function called 'main' that prompts the user for answers, generates an SVG string,
